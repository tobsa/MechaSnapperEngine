...
namespace ExampleGame.Systems {
    ...
    public class EnemySelectSystem : EntitySystem, IRenderableSystem, IUpdatableSystem 
	{
		...
		public void Update(GameTime gameTime) 
        {
			...
			left.X = jackTransform.Position.X - camComp.Viewport.Width - xOffset;
			right.X = jackTransform.Position.X + camComp.Viewport.Width + xOffset;
			if (list != null) {
        ...
        /*
         * Checks if a button was pressed and a enemy was selected.
         * If a enemy was selected, sets that enemy as controllable.
         * Only works for Barraroks atm, because no other enemies are made yet
         */
